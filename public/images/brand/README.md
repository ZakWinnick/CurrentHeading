...
Generated abstract texture, pattern, and atmosphere assets for the
...
Eleven WebP files, 1.4 MB in total. That is what `src/styles/brand.css`
...
At 45.8 MB against 1.4 MB of WebP they were pure weight for files nothing
